...
export default async function MatchPageEn({ params }: { params: { slug: string } }) {
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${SITE_URL}/en/matches/${frontmatter.slug}`,
    inLanguage: "en",
  };
    ...
    <article className="match-page">
      ...
      <header className="match-page__header">
        <p className="eyebrow">
          ...
          {upperForLocale(HOME_AWAY_LABEL.en[frontmatter.homeAway], "en")}
        </p>
...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  return {
    ...
    description: frontmatter.excerpt,
    alternates: {
      canonical: `${SITE_URL}/en/matches/${frontmatter.slug}`,
      languages: {
